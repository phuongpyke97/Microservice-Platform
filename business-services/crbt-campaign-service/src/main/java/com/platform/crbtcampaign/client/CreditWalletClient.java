...
import com.platform.crbtcampaign.client.fallback.CreditWalletClientFallback;
...
@FeignClient(name = "credit-wallet-service", fallbackFactory = CreditWalletClientFallback.class)
