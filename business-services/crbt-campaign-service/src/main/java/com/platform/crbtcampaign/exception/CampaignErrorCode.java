...
public enum CampaignErrorCode implements ErrorCode {
    ...
    LYRIA_GENERATION_FILTERED("LYRIA_GENERATION_FILTERED", "Giai điệu tạo ra trùng lặp bản quyền nhạc đã có sẵn. Vui lòng thử lại để sinh giai điệu khác!", HttpStatus.BAD_REQUEST),
