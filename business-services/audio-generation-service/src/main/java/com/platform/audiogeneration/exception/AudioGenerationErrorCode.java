...
public enum AudioGenerationErrorCode implements ErrorCode {
    ...
    INVALID_PROMPT("INVALID_PROMPT", "Prompt must be English (ASCII) for English voices or Burmese for my-MM voices, maximum 100 characters", HttpStatus.BAD_REQUEST),
